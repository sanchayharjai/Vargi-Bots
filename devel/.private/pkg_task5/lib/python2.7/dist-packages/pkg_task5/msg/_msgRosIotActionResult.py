...
"""autogenerated by genpy from pkg_task5/msgRosIotActionResult.msg. Do not edit."""
import codecs
import sys
...
class msgRosIotActionResult(genpy.Message):
  ...
  _type = "pkg_task5/msgRosIotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pkg_task5/msgRosIotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = pkg_task5.msg.msgRosIotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pkg_task5.msg.msgRosIotResult()
