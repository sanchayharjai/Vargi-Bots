...
(cl:defmethod cl:initialize-instance :after ((m <msgMqttSub>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msgMqttSub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task5-msg:<msgMqttSub> is deprecated: use pkg_task5-msg:msgMqttSub instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <msgMqttSub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task5-msg:timestamp-val is deprecated.  Use pkg_task5-msg:timestamp instead.")
  (timestamp m))
