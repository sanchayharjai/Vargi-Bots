...
(cl:defmethod cl:initialize-instance :after ((m <msgRosIotFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msgRosIotFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task5-msg:<msgRosIotFeedback> is deprecated: use pkg_task5-msg:msgRosIotFeedback instead.")))

(cl:ensure-generic-function 'percentage_complete-val :lambda-list '(m))
(cl:defmethod percentage_complete-val ((m <msgRosIotFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task5-msg:percentage_complete-val is deprecated.  Use pkg_task5-msg:percentage_complete instead.")
