...
(cl:defmethod cl:initialize-instance :after ((m <msgRosIotGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msgRosIotGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task5-msg:<msgRosIotGoal> is deprecated: use pkg_task5-msg:msgRosIotGoal instead.")))

(cl:ensure-generic-function 'protocol-val :lambda-list '(m))
(cl:defmethod protocol-val ((m <msgRosIotGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task5-msg:protocol-val is deprecated.  Use pkg_task5-msg:protocol instead.")
  (protocol m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <msgRosIotGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task5-msg:mode-val is deprecated.  Use pkg_task5-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'topic-val :lambda-list '(m))
(cl:defmethod topic-val ((m <msgRosIotGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task5-msg:topic-val is deprecated.  Use pkg_task5-msg:topic instead.")
  (topic m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <msgRosIotGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task5-msg:message-val is deprecated.  Use pkg_task5-msg:message instead.")
  (message m))
